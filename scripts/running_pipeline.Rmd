...
names_vec <- c('Astragalis purshii', 'Linnaea borealius var. borealis', 'Heliumorus multifora')

lapply(FUN = spell_check, X = names_vec, path = '/hdd/Barneby_Lives-dev/taxonomic_data')
