...
While other software packages often cost money, these are also free, and we recommend that users install an open-source PDF viewer such as Okular to review their rendered documents. 
...
Further while the software is intended for use in the context of producing herbarium labels, it's basic functionality to resolve taxonomic names, and query environmental attributes may make it useful for various land management agencies which require these utilities for various research activities. 
