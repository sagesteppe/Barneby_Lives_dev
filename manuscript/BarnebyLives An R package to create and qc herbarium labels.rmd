...
Functions that require on-disk data require a path to data as an argument.  Manually supplying the path argument allows users to judiciously determine a storage location suitable for their needs. 
