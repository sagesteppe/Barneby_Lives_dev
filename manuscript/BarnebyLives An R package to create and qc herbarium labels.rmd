...
In total the `r n_spp` collections, which underwent all processing steps, took `minutemen(sum(time_trials$elapsed, time_label_gen, as.numeric(time_final)))` minutes to process. 
