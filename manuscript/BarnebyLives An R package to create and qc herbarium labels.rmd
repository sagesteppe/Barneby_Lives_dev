...
*labels_skeleton* is an R script which will require a few modification steps to tailor to each institution, these r scripts will put data into a TEMPLATE...  
