...
It took roughly three minutes (`r sum( time_trials[time_trials$Group=='Local', 'elapsed'])`s) minutes to run all local steps of BarnebyLives, and a further 16 minutes (`r time_trials[time_trials$Function=='powo_searcher', 'elapsed']`s) to search Plants of the World Online, and `r time_trials[time_trials$Function=='directions_grabber', 'elapsed']` to search Google Maps and write directions to sites.
